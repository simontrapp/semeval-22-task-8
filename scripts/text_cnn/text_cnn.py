...
class TextCnn(nn.Module):
    def __init__(self, loss_fn, device="cuda"):
        ...
        self.network_1 = nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=5, kernel_size=3, padding='same'),
            nn.Dropout(0.2),
            nn.ReLU6(),
            nn.MaxPool2d(kernel_size=(2, 3)),
            nn.Conv2d(in_channels=5, out_channels=20, kernel_size=3, padding='same'),
            nn.ReLU6(),
            nn.MaxPool2d(kernel_size=(2, 3)),
            nn.Conv2d(in_channels=20, out_channels=100, kernel_size=3, padding='same'),
            nn.Dropout(0.2),
            nn.ReLU6(),
            nn.MaxPool2d(kernel_size=(2, 3)),
